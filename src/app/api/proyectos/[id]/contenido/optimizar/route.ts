...
// GET: historial de optimizaciones previas para una URL (?url=...) — gratis,
// solo lee lo ya persistido.
...
export async function POST(
  ...
  try {
    const outcome = await getOrComputeTfidfResult({ projectId: id, keyword: targetKeyword });
  ...
  // El coste del TF-IDF (si se calculó de nuevo) ya lo registra
  // getOrComputeTfidfResult internamente — solo registramos el del LLM aquí.
